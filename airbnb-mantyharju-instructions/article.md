...
Sauna has floor heating feature to help the floor to dry after use. I recommend using it when using the Sauna in cold weather. The heating feature can be switched on from the electric switch cabinet behind the sauna by flicking ON the switch number 6 (marked with “F”) as shown in the pictures below.

If you use the sauna floor heating feature, *remember to switch it OFF* at the end of your stay.
